...
const streetart = [
  ...
  },
  {
    ...
    other_location_note:
      "between the São Vicente Monastery  and the Graça viewpoint",
    latitude: "38.7159256",
    longitude: "-9.1312927",
  ...
  },
  {
    ...
    other_location_note:
      "faces the river by the Carriages Museum, on the departure point of the ships of the Age of Discovery.",
    latitude: "38.6968141",
    longitude: "-9.196979",
  ...
  },
  {
    ...
    other_location_note:
      "the underpass that takes you to the Alcântara-Mar train station and Santo Amaro docks",
    latitude: "38.7026577",
    longitude: "-9.1772179",
  ...
  },
  {
    ...
    other_location_note:
      "Chão do Loureiro, found between downtown and the castle",
    latitude: "38.7123757",
    longitude: "-9.1372043",
  ...
  },
  {
    ...
    name_description:
      "Vhils first carving of a face into the outside of a wall, many murals both inside and outside the walls of Fábrica do Braço de Prata",
    other_location_note: "",
    latitude: "38.7586715",
    longitude: "-9.2228381",
...
Streetart.create(streetart)
  ...
  .catch((err) =>
    console.log(
      `An error occurred while creating streetart from the DB: ${err}`
    )
  );
